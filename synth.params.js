...
window.SYNTH_PARAMS = {
  ...
  bodyEnv: {                // ЕДИНАЯ огибающая корпуса (ADSR) — применяется к обоим корпусам A и B
    attack: 0.04,          // Время атаки (сек). Больше — мягче вход
  ...
  fmHarmonicity: 3,    // Отношение частот модулятор/носитель. Нецелые → металлический оттенок
  ...
  lowpassFreq: 1000,  // Low-Pass после компа (Гц). Ниже — темнее/мягче
  ...
  delayWet:  0.1,  // Сколько дилея подмешать в микс. 0..1
  // ==== Динамика от индекса  ====
